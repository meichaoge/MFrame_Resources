...
//**********测试发现不是特别稳定有时候能够定位到使用Debug 地方 有时候不行  ....但是提供了一个思路
...
//        private static string m_DebugScriptPath = "Assets/Script/MFrameWork/Debug/LogUtility.cs";  //当前脚本的位置
...
//            var stackFrame = stackTrace.GetFrame(2); //**这里如果直接使用LogUtility 的Log 则值是2 ，如果其他的类包装了这一层 则要+1
//#if UNITY_EDITOR
...
//        static LogUtility()
//        {
//            s_InstanceID = AssetDatabase.LoadAssetAtPath<MonoScript>(m_DebugScriptPath).GetInstanceID();
